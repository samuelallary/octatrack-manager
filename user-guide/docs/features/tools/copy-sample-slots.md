...
- **Automatic Backup:** Before executing, the app automatically backs up `project.work`, `markers.work`, and any destination audio files (`.wav` + `.ot`) that would be overwritten. See [Tools Overview](./index.md) for details.
